...
export default function RideListPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="sticky top-[105px] z-40 bg-white/90 backdrop-blur-sm border-b border-gray-100">
            ...
            {dates.map((d) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={active ? 'text-blue-200' : 'text-gray-400'}>{sub}</span>
                </button>
              );
            })}
          </div>
      ...
      <div className="max-w-3xl mx-auto px-4 pb-3">
        ...
        <div className="rounded-2xl bg-white border border-gray-100 p-3">
          ...
          <p className="text-[11px] text-gray-400 mt-2">원하는 10분 단위를 누르면 해당 시간 파티만 보여줍니다.</p>
        </div>
      </div>
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
        <Link
          to="/create"
          className="
          flex items-center gap-2 bg-gradient-to-r from-blue-800 to-blue-600
          text-white px-6 py-4 rounded-2xl font-bold text-sm
          shadow-xl shadow-blue-800/30
          hover:shadow-2xl hover:shadow-blue-800/40 hover:-translate-y-0.5
...
function PartyDetailSheet({ party, loading, actionLoading, onClose, onJoin, onLeave }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] bg-black/30 flex items-end justify-center" onClick={onClose}>
      <div
        className="w-full max-w-3xl bg-white rounded-t-3xl p-5 pb-7 shadow-2xl"
        ...
        {loading || !party ? (
          ...
          <div className="space-y-4">
            <div className="rounded-2xl bg-blue-50 border border-blue-100 p-4">
              <p className="text-sm text-blue-700 font-semibold mb-1">현재 익명 인원</p>
              <p className="text-2xl font-extrabold text-blue-900">
                {party.currentCount}/{party.maxCount}명
              </p>
              <p className="text-xs text-blue-500 mt-1">3초마다 자동 갱신됩니다.</p>
            </div>
